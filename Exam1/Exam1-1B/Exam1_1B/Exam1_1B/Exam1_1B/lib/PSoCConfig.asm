...
export LoadConfig_Exam1_1B
export _LoadConfig_Exam1_1B
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Exam1_1B
	lcall	LoadConfigTBL_Exam1_1B_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Exam1_1B
;
;    Load configuration registers for Exam1_1B.
...
_LoadConfig_Exam1_1B:
 LoadConfig_Exam1_1B:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Exam1_1B_Bank0
    mov     X, <LoadConfigTBL_Exam1_1B_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Exam1_1B_Bank1
    mov     X, <LoadConfigTBL_Exam1_1B_Bank1
