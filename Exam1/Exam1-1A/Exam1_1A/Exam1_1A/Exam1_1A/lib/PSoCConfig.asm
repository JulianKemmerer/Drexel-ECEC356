...
export LoadConfig_exam1_1a
export _LoadConfig_exam1_1a
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_exam1_1a
	lcall	LoadConfigTBL_exam1_1a_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration exam1_1a
;
;    Load configuration registers for exam1_1a.
...
_LoadConfig_exam1_1a:
 LoadConfig_exam1_1a:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_exam1_1a_Bank0
    mov     X, <LoadConfigTBL_exam1_1a_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_exam1_1a_Bank1
    mov     X, <LoadConfigTBL_exam1_1a_Bank1
