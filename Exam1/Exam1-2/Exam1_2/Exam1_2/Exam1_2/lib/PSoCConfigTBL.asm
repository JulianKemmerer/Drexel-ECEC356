...
export LoadConfigTBL_exam1_2_Bank1
export LoadConfigTBL_exam1_2_Bank0
export LoadConfigTBL_exam1_2_Ordered
AREA lit(rom, rel)
LoadConfigTBL_exam1_2_Bank0:
...
;  Global Register values Bank 1
	...
	db		dfh, 63h		; OscillatorControl_3 register (OSC_CR3)
