...
export LoadConfig_exam1_2
export _LoadConfig_exam1_2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_exam1_2
	lcall	LoadConfigTBL_exam1_2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration exam1_2
;
;    Load configuration registers for exam1_2.
...
_LoadConfig_exam1_2:
 LoadConfig_exam1_2:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_exam1_2_Bank0
    mov     X, <LoadConfigTBL_exam1_2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_exam1_2_Bank1
    mov     X, <LoadConfigTBL_exam1_2_Bank1
