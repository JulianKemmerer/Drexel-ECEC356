...
export LoadConfig_quiz1
export _LoadConfig_quiz1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_quiz1
	lcall	LoadConfigTBL_quiz1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration quiz1
;
;    Load configuration registers for quiz1.
...
_LoadConfig_quiz1:
 LoadConfig_quiz1:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_quiz1_Bank0
    mov     X, <LoadConfigTBL_quiz1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_quiz1_Bank1
    mov     X, <LoadConfigTBL_quiz1_Bank1
