...
export LoadConfigTBL_quiz1_Bank1
export LoadConfigTBL_quiz1_Bank0
export LoadConfigTBL_quiz1_Ordered
AREA lit(rom, rel)
LoadConfigTBL_quiz1_Bank0:
