...
export LoadConfigTBL_hw2seq_Bank1
export LoadConfigTBL_hw2seq_Bank0
export LoadConfigTBL_hw2seq_Ordered
AREA lit(rom, rel)
LoadConfigTBL_hw2seq_Bank0:
