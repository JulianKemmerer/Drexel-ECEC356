...
export LoadConfig_hw2seq
export _LoadConfig_hw2seq
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_hw2seq
	lcall	LoadConfigTBL_hw2seq_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration hw2seq
;
;    Load configuration registers for hw2seq.
...
_LoadConfig_hw2seq:
 LoadConfig_hw2seq:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_hw2seq_Bank0
    mov     X, <LoadConfigTBL_hw2seq_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_hw2seq_Bank1
    mov     X, <LoadConfigTBL_hw2seq_Bank1
