...
export LoadConfigTBL_hw2sqwav_Bank1
export LoadConfigTBL_hw2sqwav_Bank0
export LoadConfigTBL_hw2sqwav_Ordered
AREA lit(rom, rel)
LoadConfigTBL_hw2sqwav_Bank0:
...
;  Global Register values Bank 0
	...
	db		b0h, c0h		; Row_0_InputMux register (RDI0RI)
	...
	db		ffh
LoadConfigTBL_hw2sqwav_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name Timer, User Module Timer16
;       Instance name Timer, Block Name TIMER16_LSB(DBB00)
	db		20h, 10h		;Timer_FUNC_LSB_REG(DBB00FN)
	db		21h, f4h		;Timer_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;Timer_OUTPUT_LSB_REG(DBB00OU)
;       Instance name Timer, Block Name TIMER16_MSB(DBB01)
	db		24h, 30h		;Timer_FUNC_MSB_REG(DBB01FN)
	db		25h, 34h		;Timer_INPUT_MSB_REG(DBB01IN)
...
LoadConfigTBL_hw2sqwav_Ordered:
;  Ordered Global Register values
	...
	mov	reg[06h], 80h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
