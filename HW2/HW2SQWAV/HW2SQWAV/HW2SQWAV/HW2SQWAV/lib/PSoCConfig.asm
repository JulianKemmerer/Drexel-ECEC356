...
export LoadConfig_hw2sqwav
export _LoadConfig_hw2sqwav
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_hw2sqwav
	lcall	LoadConfigTBL_hw2sqwav_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration hw2sqwav
;
;    Load configuration registers for hw2sqwav.
...
_LoadConfig_hw2sqwav:
 LoadConfig_hw2sqwav:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_hw2sqwav_Bank0
    mov     X, <LoadConfigTBL_hw2sqwav_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_hw2sqwav_Bank1
    mov     X, <LoadConfigTBL_hw2sqwav_Bank1
