...
export LoadConfig_CustomFanProject
export _LoadConfig_CustomFanProject
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_CustomFanProject
	lcall	LoadConfigTBL_CustomFanProject_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration CustomFanProject
;
;    Load configuration registers for CustomFanProject.
...
;               CUR_PP
;
_LoadConfig_CustomFanProject:
 LoadConfig_CustomFanProject:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_CustomFanProject_Bank0
    mov     X, <LoadConfigTBL_CustomFanProject_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_CustomFanProject_Bank1
    mov     X, <LoadConfigTBL_CustomFanProject_Bank1
