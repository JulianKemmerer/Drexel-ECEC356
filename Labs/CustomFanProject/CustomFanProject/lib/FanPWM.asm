...
;  Global Symbols
;-----------------------------------------------
export  FanPWM_EnableInt
export _FanPWM_EnableInt
export  FanPWM_DisableInt
export _FanPWM_DisableInt
export  FanPWM_Start
export _FanPWM_Start
export  FanPWM_Stop
export _FanPWM_Stop
export  FanPWM_WritePeriod
export _FanPWM_WritePeriod
export  FanPWM_WritePulseWidth
export _FanPWM_WritePulseWidth
export  FanPWM_bReadPulseWidth
export _FanPWM_bReadPulseWidth
export  FanPWM_bReadCounter
export _FanPWM_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bFanPWM_ReadPulseWidth    ; deprecated
export _bFanPWM_ReadPulseWidth    ; deprecated
export  bFanPWM_ReadCounter       ; deprecated
export _bFanPWM_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: FanPWM_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: FanPWM_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: FanPWM_WritePeriod
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: FanPWM_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 FanPWM_WritePulseWidth:
_FanPWM_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[FanPWM_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: FanPWM_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 FanPWM_bReadPulseWidth:
_FanPWM_bReadPulseWidth:
 bFanPWM_ReadPulseWidth:                         ; this name deprecated
_bFanPWM_ReadPulseWidth:                         ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[FanPWM_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: FanPWM_bReadCounter
;
;  DESCRIPTION:
...
;
 FanPWM_bReadCounter:
_FanPWM_bReadCounter:
 bFanPWM_ReadCounter:                            ; this name deprecated
_bFanPWM_ReadCounter:                            ; this name deprecated
   ...
   mov   A, reg[FanPWM_COMPARE_REG]              ; Save the Compare register on the stack
   push  A                                       ;
   FanPWM_Stop_M                                 ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[FanPWM_INPUT_REG]                ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[FanPWM_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[FanPWM_COUNTER_REG]              ; DR2 <- DR0
   mov   A, reg[FanPWM_COMPARE_REG]              ; Stash the Count on the stack
   ...
   mov   reg[FanPWM_INPUT_REG], A                ;
   M8C_SetBank0                                  ;
   FanPWM_Start_M                                ;   then re-enable the PWM.
