...
export LoadConfigTBL_CustomFanProject_Bank1
export LoadConfigTBL_CustomFanProject_Bank0
export LoadConfigTBL_CustomFanProject_Ordered
AREA lit(rom, rel)
LoadConfigTBL_CustomFanProject_Bank0:
;  Instance name FanPWM, User Module PWM8
;       Instance name FanPWM, Block Name PWM8(DBB00)
	db		23h, 00h		;FanPWM_CONTROL_REG(DBB00CR0)
	db		21h, ffh		;FanPWM_PERIOD_REG(DBB00DR1)
	db		22h, 00h		;FanPWM_COMPARE_REG(DBB00DR2)
;  Instance name LCD, User Module LCD
;  Instance name TachTimer, User Module Timer16
;       Instance name TachTimer, Block Name TIMER16_LSB(DBB10)
	db		33h, 00h		;TachTimer_CONTROL_LSB_REG(DBB10CR0)
	db		31h, ffh		;TachTimer_PERIOD_LSB_REG(DBB10DR1)
	db		32h, 00h		;TachTimer_COMPARE_LSB_REG(DBB10DR2)
;       Instance name TachTimer, Block Name TIMER16_MSB(DBB11)
	db		37h, 06h		;TachTimer_CONTROL_MSB_REG(DBB11CR0)
	db		35h, ffh		;TachTimer_PERIOD_MSB_REG(DBB11DR1)
	db		36h, 00h		;TachTimer_COMPARE_MSB_REG(DBB11DR2)
;  Global Register values Bank 0
	...
	db		c0h, 20h		; Row_2_InputMux register (RDI2RI)
	...
	db		ffh
LoadConfigTBL_CustomFanProject_Bank1:
;  Instance name FanPWM, User Module PWM8
;       Instance name FanPWM, Block Name PWM8(DBB00)
...
;  Instance name TachTimer, User Module Timer16
;       Instance name TachTimer, Block Name TIMER16_LSB(DBB10)
	db		30h, 10h		;TachTimer_FUNC_LSB_REG(DBB10FN)
	db		31h, e1h		;TachTimer_INPUT_LSB_REG(DBB10IN)
	db		32h, 40h		;TachTimer_OUTPUT_LSB_REG(DBB10OU)
;       Instance name TachTimer, Block Name TIMER16_MSB(DBB11)
	db		34h, 30h		;TachTimer_FUNC_MSB_REG(DBB11FN)
	db		35h, 31h		;TachTimer_INPUT_MSB_REG(DBB11IN)
	db		36h, 40h		;TachTimer_OUTPUT_MSB_REG(DBB11OU)
;  Global Register values Bank 1
	...
	db		dfh, 07h		; OscillatorControl_3 register (OSC_CR3)
...
LoadConfigTBL_CustomFanProject_Ordered:
;  Ordered Global Register values
	...
	mov	reg[05h], aeh		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], aah		; Port_1_DriveMode_2 register (PRT1DM2)
