...
#define CLOCK_DIV_VC3          0x7     // VC3 clock divider
#define CLOCK_DIV_VC3_MASK     0xff    // VC3 clock divider mask
#define CLOCK_DIV_VC3_JUST     0x7     // VC3 clock divider justified
...
#define PORT_1_GLOBAL_SELECT   0x14    //Port 1 global select register (PRT1GS)
#define PORT_1_DRIVE_0         0x50    //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0xae    //Port 1 drive mode 1 register (PRT1DM1)
#define PORT_1_DRIVE_2         0xaa    //Port 1 drive mode 2 register (PRT1DM2)
#define PORT_1_INTENABLE       0x1     //Port 1 interrupt enable register (PRT1IE)
#define PORT_1_INTCTRL_0       0x0     //Port 1 interrupt control 0 register (PRT1IC0)
#define PORT_1_INTCTRL_1       0x1     //Port 1 interrupt control 1 register (PRT1IC1)
