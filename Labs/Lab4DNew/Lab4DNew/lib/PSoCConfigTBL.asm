...
export LoadConfigTBL_Lab4DNew_Bank1
export LoadConfigTBL_Lab4DNew_Bank0
export LoadConfigTBL_Lab4DNew_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab4DNew_Bank0:
...
LoadConfigTBL_Lab4DNew_Ordered:
