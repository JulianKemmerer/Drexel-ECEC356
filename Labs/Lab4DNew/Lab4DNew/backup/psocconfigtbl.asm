...
;       Instance name TachTimer, Block Name TIMER16_LSB(DBB10)
	...
	db		31h, 00h		;TachTimer_PERIOD_LSB_REG(DBB10DR1)
	db		32h, 00h		;TachTimer_COMPARE_LSB_REG(DBB10DR2)
;       Instance name TachTimer, Block Name TIMER16_MSB(DBB11)
	db		37h, 04h		;TachTimer_CONTROL_MSB_REG(DBB11CR0)
	db		35h, 00h		;TachTimer_PERIOD_MSB_REG(DBB11DR1)
...
;       Instance name TachTimer, Block Name TIMER16_LSB(DBB10)
	...
	db		31h, 05h		;TachTimer_INPUT_LSB_REG(DBB10IN)
	db		32h, 00h		;TachTimer_OUTPUT_LSB_REG(DBB10OU)
;       Instance name TachTimer, Block Name TIMER16_MSB(DBB11)
	db		34h, 20h		;TachTimer_FUNC_MSB_REG(DBB11FN)
	db		35h, 35h		;TachTimer_INPUT_MSB_REG(DBB11IN)
	db		36h, 00h		;TachTimer_OUTPUT_MSB_REG(DBB11OU)
