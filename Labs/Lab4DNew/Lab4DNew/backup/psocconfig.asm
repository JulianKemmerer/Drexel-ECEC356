...
export LoadConfig_Lab4DNew
export _LoadConfig_Lab4DNew
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab4DNew
	lcall	LoadConfigTBL_Lab4DNew_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab4DNew
;
;    Load configuration registers for Lab4DNew.
...
_LoadConfig_Lab4DNew:
 LoadConfig_Lab4DNew:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab4DNew_Bank0
    mov     X, <LoadConfigTBL_Lab4DNew_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab4DNew_Bank1
    mov     X, <LoadConfigTBL_Lab4DNew_Bank1
