...
export LoadConfigTBL_Lab7C_Bank1
export LoadConfigTBL_Lab7C_Bank0
export LoadConfigTBL_Lab7C_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab7C_Bank0:
;  Instance name DAC6, User Module DAC6
;       Instance name DAC6, Block Name DAC(ASC10)
	db		80h, 80h		;DAC6_CR0(ASC10CR0)
	db		81h, 40h		;DAC6_CR1(ASC10CR1)
	db		82h, a0h		;DAC6_CR2(ASC10CR2)
	db		83h, 30h		;DAC6_CR3(ASC10CR3)
