...
export LoadConfig_Lab5A
export _LoadConfig_Lab5A
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab5A
	lcall	LoadConfigTBL_Lab5A_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab5A
;
;    Load configuration registers for Lab5A.
...
_LoadConfig_Lab5A:
 LoadConfig_Lab5A:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab5A_Bank0
    mov     X, <LoadConfigTBL_Lab5A_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab5A_Bank1
    mov     X, <LoadConfigTBL_Lab5A_Bank1
