...
export LoadConfigTBL_Lab5A_Bank1
export LoadConfigTBL_Lab5A_Bank0
export LoadConfigTBL_Lab5A_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab5A_Bank0:
