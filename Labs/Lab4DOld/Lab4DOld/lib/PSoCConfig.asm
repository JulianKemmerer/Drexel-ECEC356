...
export LoadConfig_Lab4DOld
export _LoadConfig_Lab4DOld
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab4DOld
	lcall	LoadConfigTBL_Lab4DOld_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab4DOld
;
;    Load configuration registers for Lab4DOld.
...
_LoadConfig_Lab4DOld:
 LoadConfig_Lab4DOld:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab4DOld_Bank0
    mov     X, <LoadConfigTBL_Lab4DOld_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab4DOld_Bank1
    mov     X, <LoadConfigTBL_Lab4DOld_Bank1
