...
export LoadConfigTBL_Lab4DOld_Bank1
export LoadConfigTBL_Lab4DOld_Bank0
export LoadConfigTBL_Lab4DOld_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab4DOld_Bank0:
...
LoadConfigTBL_Lab4DOld_Ordered:
