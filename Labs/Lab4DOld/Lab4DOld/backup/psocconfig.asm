...
export LoadConfig_Lab4D
export _LoadConfig_Lab4D
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab4D
	lcall	LoadConfigTBL_Lab4D_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab4D
;
;    Load configuration registers for Lab4D.
...
_LoadConfig_Lab4D:
 LoadConfig_Lab4D:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab4D_Bank0
    mov     X, <LoadConfigTBL_Lab4D_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab4D_Bank1
    mov     X, <LoadConfigTBL_Lab4D_Bank1
