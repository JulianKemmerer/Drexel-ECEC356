...
export LoadConfigTBL_Lab4D_Bank1
export LoadConfigTBL_Lab4D_Bank0
export LoadConfigTBL_Lab4D_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab4D_Bank0:
