...
#define CLOCK_DIV_VC3          0x5d    // VC3 clock divider
#define CLOCK_DIV_VC3_MASK     0xff    // VC3 clock divider mask
#define CLOCK_DIV_VC3_JUST     0x5d    // VC3 clock divider justified
...
#define PORT_1_GLOBAL_SELECT   0x10    //Port 1 global select register (PRT1GS)
#define PORT_1_DRIVE_0         0x10    //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0xee    //Port 1 drive mode 1 register (PRT1DM1)
#define PORT_1_DRIVE_2         0xee    //Port 1 drive mode 2 register (PRT1DM2)
