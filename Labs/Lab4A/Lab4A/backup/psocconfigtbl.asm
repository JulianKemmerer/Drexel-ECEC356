...
export LoadConfigTBL_lab4a_Bank1
export LoadConfigTBL_lab4a_Bank0
export LoadConfigTBL_lab4a_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab4a_Bank0:
