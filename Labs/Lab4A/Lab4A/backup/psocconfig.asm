...
export LoadConfig_lab4a
export _LoadConfig_lab4a
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab4a
	lcall	LoadConfigTBL_lab4a_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab4a
;
;    Load configuration registers for lab4a.
...
_LoadConfig_lab4a:
 LoadConfig_lab4a:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab4a_Bank0
    mov     X, <LoadConfigTBL_lab4a_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab4a_Bank1
    mov     X, <LoadConfigTBL_lab4a_Bank1
