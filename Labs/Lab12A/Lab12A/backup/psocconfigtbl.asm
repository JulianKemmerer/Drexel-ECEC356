...
export LoadConfigTBL_Lab12A_Bank1
export LoadConfigTBL_Lab12A_Bank0
export LoadConfigTBL_Lab12A_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab12A_Bank0:
...
;       Instance name FanPWM, Block Name PWM8(DBB00)
	...
	db		22h, 80h		;FanPWM_COMPARE_REG(DBB00DR2)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_Lab12A_Bank1:
;  Instance name FanPWM, User Module PWM8
;       Instance name FanPWM, Block Name PWM8(DBB00)
	db		20h, 31h		;FanPWM_FUNC_REG(DBB00FN)
	db		21h, 11h		;FanPWM_INPUT_REG(DBB00IN)
	db		22h, 04h		;FanPWM_OUTPUT_REG(DBB00OU)
;  Instance name LCD, User Module LCD
;  Instance name TachTimer, User Module Timer16
;       Instance name TachTimer, Block Name TIMER16_LSB(DBB10)
	db		30h, 00h		;TachTimer_FUNC_LSB_REG(DBB10FN)
	db		31h, e5h		;TachTimer_INPUT_LSB_REG(DBB10IN)
	db		32h, 40h		;TachTimer_OUTPUT_LSB_REG(DBB10OU)
;       Instance name TachTimer, Block Name TIMER16_MSB(DBB11)
	db		34h, 20h		;TachTimer_FUNC_MSB_REG(DBB11FN)
	db		35h, 35h		;TachTimer_INPUT_MSB_REG(DBB11IN)
...
;  Global Register values Bank 1
	...
	db		dfh, 5dh		; OscillatorControl_3 register (OSC_CR3)
