...
export LoadConfig_Lab12A
export _LoadConfig_Lab12A
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab12A
	lcall	LoadConfigTBL_Lab12A_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab12A
;
;    Load configuration registers for Lab12A.
...
_LoadConfig_Lab12A:
 LoadConfig_Lab12A:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab12A_Bank0
    mov     X, <LoadConfigTBL_Lab12A_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab12A_Bank1
    mov     X, <LoadConfigTBL_Lab12A_Bank1
