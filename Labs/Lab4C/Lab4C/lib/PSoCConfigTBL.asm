...
export LoadConfigTBL_Lab4C_Bank1
export LoadConfigTBL_Lab4C_Bank0
export LoadConfigTBL_Lab4C_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab4C_Bank0:
...
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[07h], aeh		; Port_1_DriveMode_2 register (PRT1DM2)
