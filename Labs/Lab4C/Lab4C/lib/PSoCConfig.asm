...
export LoadConfig_Lab4C
export _LoadConfig_Lab4C
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab4C
	lcall	LoadConfigTBL_Lab4C_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab4C
;
;    Load configuration registers for Lab4C.
...
_LoadConfig_Lab4C:
 LoadConfig_Lab4C:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab4C_Bank0
    mov     X, <LoadConfigTBL_Lab4C_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab4C_Bank1
    mov     X, <LoadConfigTBL_Lab4C_Bank1
