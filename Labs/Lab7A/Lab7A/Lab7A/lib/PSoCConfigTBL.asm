...
export LoadConfigTBL_lab7a_Bank1
export LoadConfigTBL_lab7a_Bank0
export LoadConfigTBL_lab7a_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab7a_Bank0:
;  Instance name RefAgndMux, User Module RefMux
;       Instance name RefAgndMux, Block Name REFMUX(ACB02)
	db		79h, 01h		;RefAgndMux_REFMUX_CR0(ACB02CR0)
	db		7ah, 09h		;RefAgndMux_REFMUX_CR1(ACB02CR1)
	db		7bh, 14h		;RefAgndMux_REFMUX_CR2(ACB02CR2)
	db		78h, 00h		;RefAgndMux_REFMUX_CR3(ACB02CR3)
;  Instance name RefHiMux, User Module RefMux
;       Instance name RefHiMux, Block Name REFMUX(ACB00)
	db		71h, 01h		;RefHiMux_REFMUX_CR0(ACB00CR0)
	db		72h, 09h		;RefHiMux_REFMUX_CR1(ACB00CR1)
	db		73h, 1ch		;RefHiMux_REFMUX_CR2(ACB00CR2)
	db		70h, 00h		;RefHiMux_REFMUX_CR3(ACB00CR3)
;  Instance name RefLoMux, User Module RefMux
;       Instance name RefLoMux, Block Name REFMUX(ACB01)
	db		75h, 01h		;RefLoMux_REFMUX_CR0(ACB01CR0)
	db		76h, 09h		;RefLoMux_REFMUX_CR1(ACB01CR1)
	db		77h, 18h		;RefLoMux_REFMUX_CR2(ACB01CR2)
	db		74h, 00h		;RefLoMux_REFMUX_CR3(ACB01CR3)
;  Global Register values Bank 0
	db		60h, 28h		; AnalogColumnInputSelect register (AMX_IN)
	db		66h, 00h		; AnalogComparatorControl1 register (CMP_CR1)
	db		63h, 1fh		; AnalogReferenceControl register (ARF_CR)
...
;  Global Register values Bank 1
	...
	db		62h, 38h		; AnalogIOControl_0 register (ABF_CR0)
