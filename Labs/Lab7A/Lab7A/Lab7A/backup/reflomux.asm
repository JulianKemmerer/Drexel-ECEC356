...
;  Global Symbols
;-----------------------------------------------
export  RefLoMux_Start
export _RefLoMux_Start

export  RefLoMux_SetPower
export _RefLoMux_SetPower

export  RefLoMux_Stop
export _RefLoMux_Stop

export  RefLoMux_RefSelect
export _RefLoMux_RefSelect
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RefLoMux_Start
;  FUNCTION NAME: RefLoMux_SetPower
;
;  DESCRIPTION:
...
_RefLoMux_SetPower:
    ...
    mov  A, reg[RefLoMux_REFMUX_CR2]   ; read power value
    and  A, ~POWERMASK                 ; clear power bits in A
    or   A, [X]                        ; combine power value with balance of reg.
    mov  reg[RefLoMux_REFMUX_CR2], A   ; move complete value back to register
    pop  A
...
_RefLoMux_Stop:
    ...
    and REG[RefLoMux_REFMUX_CR2], ~POWERMASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RefLoMux_InputSelect
;
;  DESCRIPTION:
...
_RefLoMux_RefSelect:
    ...
    push A
    mov  A,reg[RefLoMux_REFMUX_CR2]    ; Write register Test Mux register to select reference
    and  A, ~TMUX_MASK                 ; Clear Mux control bits
    or   A,[X]                         ; Or in the new setting
    mov  reg[RefLoMux_REFMUX_CR2],A    ; Write register Test Mux register to select reference
