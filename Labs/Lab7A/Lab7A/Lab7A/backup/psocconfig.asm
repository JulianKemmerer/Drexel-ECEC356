...
export LoadConfig_lab7a
export _LoadConfig_lab7a
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab7a
	lcall	LoadConfigTBL_lab7a_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab7a
;
;    Load configuration registers for lab7a.
...
_LoadConfig_lab7a:
 LoadConfig_lab7a:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab7a_Bank0
    mov     X, <LoadConfigTBL_lab7a_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab7a_Bank1
    mov     X, <LoadConfigTBL_lab7a_Bank1
