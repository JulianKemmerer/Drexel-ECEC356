...
export LoadConfigTBL_exam2_Bank1
export LoadConfigTBL_exam2_Bank0
export LoadConfigTBL_exam2_Ordered
AREA lit(rom, rel)
LoadConfigTBL_exam2_Bank0:
...
;       Instance name Counter16, Block Name CNTR16_LSB(DBB00)
	...
	db		21h, e0h		;Counter16_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 28h		;Counter16_COMPARE_LSB_REG(DBB00DR2)
;       Instance name Counter16, Block Name CNTR16_MSB(DBB01)
	db		27h, 00h		;Counter16_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 01h		;Counter16_PERIOD_MSB_REG(DBB01DR1)
...
;       Instance name SCDAC, Block Name SCBLK(ASC10)
	...
	db		82h, 20h		;SCDAC_cr2(ASC10CR2)
	db		83h, 33h		;SCDAC_cr3(ASC10CR3)
;  Instance name SCGain, User Module SCBLOCK
;       Instance name SCGain, Block Name SCBLK(ASD20)
	db		90h, 30h		;SCGain_cr0(ASD20CR0)
	db		91h, 00h		;SCGain_cr1(ASD20CR1)
	db		92h, a0h		;SCGain_cr2(ASD20CR2)
	db		93h, 33h		;SCGain_cr3(ASD20CR3)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_exam2_Bank1:
;  Instance name Counter16, User Module Counter16
;       Instance name Counter16, Block Name CNTR16_LSB(DBB00)
	db		20h, 01h		;Counter16_FUNC_LSB_REG(DBB00FN)
	db		21h, 15h		;Counter16_INPUT_LSB_REG(DBB00IN)
	db		22h, c0h		;Counter16_OUTPUT_LSB_REG(DBB00OU)
;       Instance name Counter16, Block Name CNTR16_MSB(DBB01)
	db		24h, 21h		;Counter16_FUNC_MSB_REG(DBB01FN)
	db		25h, 35h		;Counter16_INPUT_MSB_REG(DBB01IN)
	db		26h, c0h		;Counter16_OUTPUT_MSB_REG(DBB01OU)
;  Instance name LCD, User Module LCD
;  Instance name SCDAC, User Module SCBLOCK
;       Instance name SCDAC, Block Name SCBLK(ASC10)
;  Instance name SCGain, User Module SCBLOCK
...
;  Global Register values Bank 1
	...
	db		60h, 01h		; AnalogColumnClockSelect register (CLK_CR0)
	...
	db		e1h, 33h		; OscillatorControl_1 register (OSC_CR1)
