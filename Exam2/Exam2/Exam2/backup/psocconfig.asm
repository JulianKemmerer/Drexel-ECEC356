...
export LoadConfig_exam2
export _LoadConfig_exam2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_exam2
	lcall	LoadConfigTBL_exam2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration exam2
;
;    Load configuration registers for exam2.
...
_LoadConfig_exam2:
 LoadConfig_exam2:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_exam2_Bank0
    mov     X, <LoadConfigTBL_exam2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_exam2_Bank1
    mov     X, <LoadConfigTBL_exam2_Bank1
