...
export LoadConfig_quiz2
export _LoadConfig_quiz2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_quiz2
	lcall	LoadConfigTBL_quiz2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration quiz2
;
;    Load configuration registers for quiz2.
...
_LoadConfig_quiz2:
 LoadConfig_quiz2:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_quiz2_Bank0
    mov     X, <LoadConfigTBL_quiz2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_quiz2_Bank1
    mov     X, <LoadConfigTBL_quiz2_Bank1
