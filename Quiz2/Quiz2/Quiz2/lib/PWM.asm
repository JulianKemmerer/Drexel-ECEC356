...
;  Global Symbols
;-----------------------------------------------
export  PWM_EnableInt
export _PWM_EnableInt
export  PWM_DisableInt
export _PWM_DisableInt
export  PWM_Start
export _PWM_Start
export  PWM_Stop
export _PWM_Stop
export  PWM_WritePeriod
export _PWM_WritePeriod
export  PWM_WritePulseWidth
export _PWM_WritePulseWidth
export  PWM_bReadPulseWidth
export _PWM_bReadPulseWidth
export  PWM_bReadCounter
export _PWM_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM_ReadPulseWidth    ; deprecated
export _bPWM_ReadPulseWidth    ; deprecated
export  bPWM_ReadCounter       ; deprecated
export _bPWM_ReadCounter       ; deprecated


AREA quiz2_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_WritePulseWidth
;
;  DESCRIPTION:
...
;
 PWM_WritePulseWidth:
_PWM_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_bReadPulseWidth
;
;  DESCRIPTION:
...
;
 PWM_bReadPulseWidth:
_PWM_bReadPulseWidth:
 bPWM_ReadPulseWidth:                            ; this name deprecated
_bPWM_ReadPulseWidth:                            ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_bReadCounter
;
;  DESCRIPTION:
...
;
 PWM_bReadCounter:
_PWM_bReadCounter:
 bPWM_ReadCounter:                               ; this name deprecated
_bPWM_ReadCounter:                               ; this name deprecated
   ...
   mov   A, reg[PWM_COMPARE_REG]                 ; Save the Compare register on the stack
   push  A                                       ;
   PWM_Stop_M                                    ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM_INPUT_REG]                   ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM_COUNTER_REG]                 ; DR2 <- DR0
   mov   A, reg[PWM_COMPARE_REG]                 ; Stash the Count on the stack
   ...
   mov   reg[PWM_INPUT_REG], A                   ;
   M8C_SetBank0                                  ;
   PWM_Start_M                                   ;   then re-enable the PWM.
