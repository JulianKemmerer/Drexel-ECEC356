...
export LoadConfigTBL_quiz2_Bank1
export LoadConfigTBL_quiz2_Bank0
export LoadConfigTBL_quiz2_Ordered
AREA lit(rom, rel)
LoadConfigTBL_quiz2_Bank0:
;  Instance name LCD, User Module LCD
;  Instance name PWM, User Module PWM8
;       Instance name PWM, Block Name PWM8(DBB00)
	db		23h, 00h		;PWM_CONTROL_REG(DBB00CR0)
	db		21h, ffh		;PWM_PERIOD_REG(DBB00DR1)
	db		22h, 80h		;PWM_COMPARE_REG(DBB00DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_quiz2_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name PWM, User Module PWM8
;       Instance name PWM, Block Name PWM8(DBB00)
	db		20h, 39h		;PWM_FUNC_REG(DBB00FN)
	db		21h, 11h		;PWM_INPUT_REG(DBB00IN)
	db		22h, 44h		;PWM_OUTPUT_REG(DBB00OU)
